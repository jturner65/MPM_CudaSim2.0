...
public class MPM_SimUpdateFromUIData extends UIDataUpdater {
    ...
    public String toString() {
        String res = "Owning Window Name: "+owner.getName()+" | Tracked values : "+intValues.size() +" Integers, " +floatValues.size() +" Floats, " +boolValues.size() + " Booleans\n";
        if (intValues.size() > 0) {
